      ...
      children: [
        Column(
          ...
          children: [
            ...
            Text(_openingTime != null ? _openingTime!.format(context) : AppLocalizations.of(context)!.timeStartUpdate),  
          ],
        ),
        ...
        Column(
          ...
          children: [
            ...
            Text(_closingTime != null ? _closingTime!.format(context) : AppLocalizations.of(context)!.timeEndUpdate),
          ],
        ),
      ],
    );
